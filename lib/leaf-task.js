...
export const LeafTask = Object.freeze({
  ...
  properties: {
    ...
    // S2-specific routing fields — required by the capability-aware broker and
    // quorum layer to route tasks to the right inference tier and seed generation.
    complexity_tier: { type: 'string', enum: ['local', 'mid', 'frontier'] },
    entropy_seed: { type: 'string', pattern: '^[0-9a-f]{8,64}$' },
